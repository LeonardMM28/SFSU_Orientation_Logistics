...
export const FinalPopupOverlay = styled.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
export const FinalPopupBox = styled.div`
  background-color: white;
  padding: 30px;
  border-radius: 10px;
  text-align: center;
...
export const FinalPopupTitle = styled.h2`
  font-size: 24px;
  margin-bottom: 20px;
`;

export const FinalPopupMessage = styled.p`
  font-size: 18px;
  color: #333;
`;
